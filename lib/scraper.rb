...
class Scraper #here is where you will pull the data and put it into a hash format. the hash will then be used by Recipe to instantiate new recipe objects
  ...
  def self.scrape_recipe_instructions #this is a method that'll extract instructions for a single recipe. this method will actually get called by another metho in Recipe.
